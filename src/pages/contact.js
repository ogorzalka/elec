      ...
      <div className="bg-gradient-to-b from-blue-900 to-blue-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-200 max-w-3xl mx-auto">
            Besoin d'un service électrique à Lens, Liévin, Arras ou Béthune ? Nous sommes là pour vous aider. Contactez-nous pour un devis gratuit ou une intervention rapide.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="bg-white shadow-2xl rounded-lg p-8">
              <h2 className="text-3xl font-bold text-blue-900 mb-6">Envoyez-nous un message</h2>
              <form
                name="contact"
                method="post"
                data-netlify="true"
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full bg-yellow-400 text-blue-900 font-bold py-4 px-6 rounded-md hover:bg-yellow-300 transition duration-300 transform hover:-translate-y-1 hover:shadow-lg"
                >
            ...
            <div className="space-y-8">
              ...
              {/* Carte Google Maps */}
              <div className="bg-white shadow-xl rounded-lg p-8">
                <h2 className="text-3xl font-bold text-blue-900 mb-6">Notre zone d'intervention</h2>
                ...
                <p className="mt-4 text-gray-600">Nous intervenons à Lens, Liévin, Arras, Béthune et dans tout le Pas-de-Calais.</p>
              </div>
            </div>
          </div>
        </div>
